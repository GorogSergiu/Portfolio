    ...
    <DefaultLayout>
      <section className="flex flex-col justify-center items-center gap-6 py-8 md:py-10">
        ...
        <div className="flex flex-col w-[80%] gap-6">
          <div className="flex w-[30%] flex-wrap md:flex-nowrap">
            <Input type="email" variant="bordered" label="Email" />
          </div>
          <div className="flex w-[30%] gap-2 flex-wrap md:flex-nowrap">
            <Input type="name" variant="bordered" label="First Name" />
            <Input type="name" variant="bordered" label="Last Name" />
          </div>
          <div className="flex w-[30%] flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
            <Textarea
              variant="bordered"
              minRows={3}
              label="Message"
